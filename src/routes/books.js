...
request.get(`https://www.goodreads.com/book/show.xml?key=NkVlEJkATW127La6gN86Q&id=${goodreadsId}`)
  .then(result =>
...
request.get(`https://www.goodreads.com/search/index.xml?key=NkVlEJkATW127La6gN86Q&q=${req.query.q}`)
  .then(result =>
   parseString(result, (err, goodreadsResult) =>
     res.json({
